        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-md relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-frnsw-red focus:border-frnsw-red focus:z-10 sm:text-sm"
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <Link to="/reset-password" className="font-medium text-frnsw-red hover:text-red-700">
          ...
          <div className="text-center">
            <span className="text-sm text-gray-600">
              ...
              <Link to="/register" className="font-medium text-frnsw-red hover:text-red-700">
                Register here
              </Link>
            </span>
          </div>
